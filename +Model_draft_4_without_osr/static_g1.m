...
if T_flag
    T = Model_draft_4_without_osr.static_g1_tt(T, y, x, params);
end
g1 = zeros(25, 25);
g1(1,1)=params(6)*2*(1+params(5));
g1(1,3)=params(6)*(1+params(5))*(-2);
g1(1,16)=(-(params(10)*(-(1+params(5)))));
g1(1,20)=1+params(17)*(-params(14));
g1(2,16)=(-params(10));
g1(2,21)=1+params(17)*(-params(15));
...
g1(6,22)=1+params(17)*(-params(14));
g1(7,18)=(-params(12));
g1(7,23)=1+params(17)*(-params(15));
...
g1(9,24)=(-(1-params(6)));
g1(10,10)=(1-params(6))*2*params(16);
