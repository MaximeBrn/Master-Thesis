...
T(10) = y(1)^params(11)*exp(x(it_, 1));
T(11) = y(3)^params(11)*exp(x(it_, 3));
T(12) = y(2)^params(12)*exp(x(it_, 2));
T(13) = y(4)^params(12)*exp(x(it_, 4));
...
T(21) = (-(getPowerDeriv(y(11),params(11),1)*exp(y(39))));
T(22) = (-(getPowerDeriv(y(12),params(12),1)*exp(y(40))));
T(23) = (-(getPowerDeriv(y(19),params(11),1)*exp(y(41))));
T(24) = (-(getPowerDeriv(y(20),params(12),1)*exp(y(42))));
