...
g2_j(47)=389;
g2_j(48)=488;
g2_v(1)=(1-params(9))*params(5)*T(7)*T(7)*getPowerDeriv(y(5)/params(5),(-params(1)),2);
g2_v(2)=params(5)*y(10)*T(7)*T(7)*getPowerDeriv(y(6)/params(5),params(4),2);
g2_v(3)=params(5)*T(8);
g2_v(4)=g2_v(3);
g2_v(5)=(-1);
g2_v(6)=g2_v(5);
g2_v(7)=params(9)*params(5)*T(7)*T(7)*getPowerDeriv(y(8)/params(5),(-params(8)),2);
g2_v(8)=(1-params(9))*(1-params(5))*T(11)*T(11)*getPowerDeriv(y(11)/(1-params(5)),(-params(1)),2);
