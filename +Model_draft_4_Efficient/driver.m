...
options_ = [];
M_.fname = 'Model_draft_4_Efficient';
...
M_.equations_tags = {
  ...
  5 , 'name' , '5' ;
  6 , 'name' , '6' ;
  7 , 'name' , 'Home TFP process' ;
  8 , 'name' , 'Home Labor disutility shifter' ;
  9 , 'name' , 'Foreign TFP process' ;
  10 , 'name' , 'Foreign Labor disutility shifter' ;
};
M_.mapping.a.eqidx = [1 2 5 7 ];
M_.mapping.xi.eqidx = [5 8 ];
M_.mapping.y_nat.eqidx = [1 2 3 5 ];
M_.mapping.g_nat.eqidx = [3 5 ];
M_.mapping.c_nat.eqidx = [1 3 4 ];
M_.mapping.a_starr.eqidx = [1 2 6 9 ];
M_.mapping.xi_starr.eqidx = [6 10 ];
M_.mapping.y_nat_starr.eqidx = [1 2 4 6 ];
M_.mapping.g_nat_starr.eqidx = [4 6 ];
M_.mapping.c_nat_starr.eqidx = [2 3 4 ];
M_.mapping.eps_a.eqidx = [7 ];
M_.mapping.eps_xi.eqidx = [8 ];
M_.mapping.eps_a_starr.eqidx = [9 ];
...
save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Model_draft_4_Efficient_results.mat'], 'oo_recursive_', '-append');
end
if ~isempty(lastwarn)
