...
@#define OSR_FP_RULE = "NX_GAP_RULE" // "G_GAP_RULE" or "F_GAP_RULE" or "F_GAP_RULE_2" or "NX_GAP_RULE" or "BEETSMA" or "BEETSMA_NATIONAL" or "KIRSANOVA" or "KIRSANOVA_NATIONAL" or "MB" or "F_GAP_RULE"
