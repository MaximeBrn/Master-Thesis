...
M_.param_names(31) = {'FP_c_gapCU'};
M_.param_names_tex(31) = {'FP\_c\_gapCU'};
M_.param_names_long(31) = {'FP_c_gapCU'};
M_.param_names(32) = {'FP_s_gapH'};
M_.param_names_tex(32) = {'FP\_s\_gapH'};
M_.param_names_long(32) = {'FP_s_gapH'};
M_.param_names(33) = {'RHOA'};
M_.param_names_tex(33) = {'RHOA'};
M_.param_names_long(33) = {'RHOA'};
...
M_.mapping.y_gap.eqidx = [53 71 ];
M_.mapping.g_gap.eqidx = [54 72 75 81 ];
M_.mapping.c_gap.eqidx = [55 73 ];
M_.mapping.c_H_gap.eqidx = [56 78 ];
M_.mapping.c_F_gap.eqidx = [57 79 ];
M_.mapping.f_gap.eqidx = [59 77 ];
M_.mapping.n_gap.eqidx = [58 ];
M_.mapping.s_gap.eqidx = [60 81 ];
M_.mapping.ii_gap.eqidx = [61 ];
M_.mapping.y_gap_starr.eqidx = [62 71 ];
M_.mapping.g_gap_starr.eqidx = [82 ];
M_.mapping.c_gap_starr.eqidx = [64 73 ];
M_.mapping.c_H_gap_starr.eqidx = [65 78 ];
M_.mapping.c_F_gap_starr.eqidx = [66 79 ];
M_.mapping.f_gap_starr.eqidx = [68 77 ];
...
M_.mapping.c_gap_cu.eqidx = [73 81 ];
...
M_.osr.variable_weights(61,61) = 1;
M_.osr.variable_indices = [M_.osr.variable_indices; 61];
M_.osr.variable_weights(60,60) = 1;
...
M_.osr.variable_weights(59,59) = 1;
M_.osr.variable_indices = [M_.osr.variable_indices; 59];
M_.osr.param_names = {'FP_c_gapCU';'FP_s_gapH'};
...
M_.osr.param_bounds(strcmp(M_.osr.param_names, 'FP_c_gapCU'), :) = [(-10), 10];
...
pol_name="OSR - POP_WEIGHT - TAYLOR - BEETSMA - FOREIGN_PASSIVE - HOME_UNCOORDINATED"   
calibration_name="h_"+h+" - ALPHA_bar_"+ALPHA_bar+" - THETA_"+THETA
benchmark_folder_name = "OUTPUT/"+calibration_name+"/"+"POP_WEIGHT/"+"RAMSEY"
folder_name = "OUTPUT/"+calibration_name+"/"+"POP_WEIGHT/"+"OSR - TAYLOR -  BEETSMA -  FOREIGN_PASSIVE -  HOME_UNCOORDINATED"
mkdir(folder_name)
T_irf=options_.irf
