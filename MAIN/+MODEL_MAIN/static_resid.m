...
residual(40) = y(67)*params(15)+y(66)*(-(1-params(15)))+(1+params(18))*params(7)*params(8)*y(65)+y(63)*(1-params(14))+y(62)*(-params(14))+(-((1+params(18))*(1-params(7))*params(8)))*y(61)+y(59)+y(58)*(-(params(17)*params(18)*params(7)*params(8)))+y(57)*params(18)*params(7)*params(8)/params(19)+y(56)*(-(params(16)*(-(params(18)*(1-params(7))*params(8)))))+y(55)*(-T(4))+T(2)*y(55)*T(4)+T(2)*y(57)*(-(params(18)*params(7)*params(8)/params(19)))-y(77);
residual(41) = y(68);
residual(42) = y(69);
residual(43) = y(70);
...
residual(56) = y(26)-(y(26)*params(1)+params(16)*((params(3)+params(19))*y(25)-params(11)*params(19)*y(27)-params(18)*(1-params(7))*params(8)*y(40)-(1+params(3))*y(10)));
residual(57) = y(32)-(y(32)-T(3)*(y(39)-y(33)));
residual(58) = y(33)-(params(1)*y(33)+params(17)*((params(3)+params(19))*y(32)-params(11)*params(19)*y(34)+params(18)*params(7)*params(8)*y(40)-(1+params(3))*y(12)));
