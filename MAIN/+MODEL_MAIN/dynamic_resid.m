...
residual(25) = (-params(7))*y(77)+params(19)*y(69)+y(67)*(-T(4))+y(64)*(-(params(16)*(params(3)+params(19))))+y(63)+T(5)*(-y(5))-y(68)-y(79);
residual(26) = params(7)*0.5*params(6)/params(16)*2*y(34)+(-params(7))*y(76)+y(64)+T(5)*y(5)*(-T(1))+T(5)*y(6)*(-params(1));
residual(27) = (-params(7))*y(78)+params(19)*(-params(11))*y(69)+y(67)*(-(T(4)*(-params(11))))+y(64)*(-(params(16)*(-(params(11)*params(19)))))+(-params(11))*y(63)+T(5)*params(11)*y(5)-y(80);
residual(28) = y(68);
residual(29) = (-params(19))*y(69)-y(70)-y(71)-y(81);
residual(30) = y(70);
residual(31) = y(71);
residual(32) = (-(1-params(7)))*y(77)+params(19)*y(73)+T(4)*y(67)+y(66)*(-((params(3)+params(19))*params(17)))+y(65)+T(5)*(-y(7))-y(72)-y(82);
residual(33) = (1-params(7))*0.5*params(6)/params(17)*2*y(41)+(-(1-params(7)))*y(76)+y(66)+T(5)*(-T(1))*y(7)+T(5)*(-params(1))*y(8);
residual(34) = (-(1-params(7)))*y(78)+params(19)*(-params(11))*y(73)+y(67)*(-(params(11)*T(4)))+y(66)*(-(params(17)*(-(params(11)*params(19)))))+(-params(11))*y(65)+T(5)*params(11)*y(7)-y(83);
residual(35) = y(72);
residual(36) = (-params(19))*y(73)-y(74)-y(75)-y(84);
residual(37) = y(74);
residual(38) = y(75);
residual(39) = T(1)*y(65)+T(1)*y(63);
residual(40) = params(15)*y(75)+y(74)*(-(1-params(15)))+(1+params(18))*params(8)*params(7)*y(73)+(1-params(14))*y(71)+y(70)*(-params(14))+(-(params(8)*(1-params(7))*(1+params(18))))*y(69)+y(67)+y(66)*(-(params(18)*params(8)*params(7)*params(17)))+T(3)*y(65)+y(64)*(-(params(16)*(-(params(18)*params(8)*(1-params(7))))))+y(63)*(-T(2))+T(5)*T(2)*y(5)+T(5)*y(7)*(-T(3))-y(85);
residual(41) = y(76);
residual(42) = y(77);
residual(43) = y(78);
...
residual(56) = y(34)-(y(93)*params(1)+params(16)*(y(33)*(params(3)+params(19))-y(35)*params(11)*params(19)-params(18)*params(8)*(1-params(7))*y(48)-(1+params(3))*y(18)));
residual(57) = y(40)-(y(95)-T(1)*(y(47)-y(96))+(y(98)-y(48))*T(3)-params(11)*(y(97)-y(42)));
residual(58) = y(41)-(params(1)*y(96)+params(17)*((params(3)+params(19))*y(40)-params(11)*params(19)*y(42)+y(48)*params(18)*params(8)*params(7)-(1+params(3))*y(20)));
residual(59) = y(48)-T(4)*(y(33)-y(40)-params(11)*(y(35)-y(42)));
