...
var
    ...
    n           ${\hat n_t}$        (long_name='Home labor (log dev ss)')
    ...
    f           ${\hat f_t}$        (long_name='Home fiscal stance (log dev ss)')
    ...
    n_starr     ${\hat n_t^*}$      (long_name='Foreign labor (log dev ss)')
    ...
    f_starr     ${\hat f_t^*}$      (long_name='Foreign fiscal stance (log dev ss)')
    ii_starr    ${i_t^*}$           (long_name='Foreign nominal interest rate (log dev ss)')
    s_starr     ${s_t^*}$           (long_name='Foreign terms of trade (log dev ss)')
    ...
    ii_cu       ${i_t^{cu}}$                 (long_name='Union nominal interest rate (log dev ss)')
