function generate_plot(oo_irfs,T_plot,my_annotation,folder_name)
...
figure('NumberTitle', 'off','visible','off')
subplot(3,3,1); % Labor
Home=plot(t,oo_irfs.n_eps_a_starr(1:T_plot),'LineWidth',1.5); hold on
...
plot(t,oo_irfs.n_nat_eps_a_starr(1:T_plot),'LineWidth',1.5); hold on
