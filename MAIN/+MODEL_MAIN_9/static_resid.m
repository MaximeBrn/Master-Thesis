...
residual(26) = lhs - rhs;
lhs = y(13);
rhs = y(4)-params(11)*y(5)-y(6)*(1-params(11))*(1+params(14)*y(11))-y(11)*params(14)*(1-params(11));
residual(27) = lhs - rhs;
lhs = y(23);
rhs = y(14)-params(11)*y(15)-y(16)*(1-params(11))*(1+params(15)*y(21))-y(21)*params(15)*(1-params(11));
residual(28) = lhs - rhs;
lhs = y(32);
...
residual(55) = lhs - rhs;
lhs = y(43);
rhs = y(33)-params(11)*y(35)-y(37)*(1-params(11))*(1+params(14)*y(41))-params(14)*(1-params(11))*y(41);
residual(56) = lhs - rhs;
lhs = y(54);
rhs = y(44)-params(11)*y(46)-y(48)*(1-params(11))*(1+params(15)*y(53))-params(15)*(1-params(11))*y(53);
residual(57) = lhs - rhs;
lhs = y(64);
...
residual(89) = lhs - rhs;
lhs = y(66);
rhs = y(66)*params(24)+params(25)*(y(74)-y(93));
residual(90) = lhs - rhs;
residual(91) = y(80);
lhs = y(1);
rhs = y(1)*params(26)-x(1);
residual(92) = lhs - rhs;
lhs = y(2);
rhs = y(2)*params(26)-x(2);
residual(93) = lhs - rhs;
lhs = y(3);
