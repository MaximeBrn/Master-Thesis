...
residual(80) = lhs - rhs;
lhs = y(64);
rhs = y(64)*params(24)+params(25)*(y(61)-y(59))+params(26)*(y(70)-y(68))+y(66)*params(27);
residual(81) = lhs - rhs;
lhs = y(73);
rhs = y(73)*params(24)+(y(61)-y(59))*params(28)+(y(70)-y(68))*params(29)+y(75)*params(30);
residual(82) = lhs - rhs;
lhs = y(1);
rhs = y(1)*params(31)-x(1);
residual(83) = lhs - rhs;
lhs = y(2);
rhs = y(2)*params(31)-x(2);
residual(84) = lhs - rhs;
lhs = y(3);
