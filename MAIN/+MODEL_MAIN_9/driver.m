...
M_.param_names(27) = {'RHOA'};
M_.param_names_tex(27) = {'RHOA'};
M_.param_names_long(27) = {'RHOA'};
...
M_.mapping.pie.eqidx = [27 29 45 81 ];
...
M_.mapping.pie_cu.eqidx = [45 80 81 ];
...
M_.mapping.y_gap_cu.eqidx = [71 80 81 ];
...
M_.state_var = [1 2 27 31 55 56 59 60 77 ];
...
CHI_G = M_.params(13);
M_.osr.param_names = {'FP_y_gapH';'FP_pieH'};
...
M_.osr.variable_weights(61,61) = (1-M_.params(11))*(M_.params(2)+(1-M_.params(11))*M_.params(3));
M_.osr.variable_indices = [M_.osr.variable_indices; 61];
M_.osr.variable_weights(60,60) = M_.params(11)*(M_.params(4)+M_.params(11)*M_.params(3));
M_.osr.variable_indices = [M_.osr.variable_indices; 60];
M_.osr.variable_weights(31,31) = M_.params(6)/M_.params(16);
M_.osr.variable_indices = [M_.osr.variable_indices; 31];
M_.osr.variable_weights(66,66) = (1-M_.params(11))*M_.params(14)*(1+(1-M_.params(11))*M_.params(3));
M_.osr.variable_indices = [M_.osr.variable_indices; 66];
M_.osr.variable_weights(61,60) = M_.params(3)*2*(1-M_.params(11));
M_.osr.variable_indices = [M_.osr.variable_indices; 61; 60];
options_.TeX = true;
options_.irf = 200;
...
[pol_name,folder_name,benchmark_folder_name]=get_folder_name("OSR","EQUAL_WEIGHT","BLANCHARD","G_GAP_RULE","FOREIGN_CONSTRAINED","HOME_DOM_ORIENTED",h,ALPHA_bar,THETA);
mkdir(folder_name)
